...
<div class="sidebar text-white p-3">
    ...
    <ul class="nav flex-column gap-2">
       ...
       <li class="nav-item">
            <a href="<?= base_url('vendor/dashboard') ?>" class="nav-link <?= $uri->getSegment(2)=='dashboard'?'active-menu':'' ?>">
                 <i class="bi bi-grid me-2"></i>
                Dashboard
            </a>
        </li>
        <li class="nav-item">
            <a href="<?= base_url('vendor/products') ?>" class="nav-link <?= $uri->getSegment(2)=='products'?'active-menu':'' ?>">
        ...
        <li class="nav-item">
            <a href="<?= base_url('vendor/orders') ?>" class="nav-link <?= $uri->getSegment(2)=='orders'?'active-menu':'' ?>">
        ...
        <li class="nav-item mt-4">
            <a href="<?= base_url('vendor/logout') ?>" class="btn btn-danger w-100">
